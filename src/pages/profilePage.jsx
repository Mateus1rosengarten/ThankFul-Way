    ...
    <>
      <div className="div-profilePage">
        <div className="div-profileName-changes">
          <div className="div-heading-input-button">
            <h3 className="h3-profileName-label">
              Profile Name
              <FontAwesomeIcon
                className="profileName-icon"
                icon={faUserEdit}
                style={{ marginLeft: "1vw", color: "#87CEEB" }}
              />
            </h3>
          ...
          <div className="div-new-profileName">
            {profileNameIsChanged ? (
              <>
                <h3 className="h3-profileName-text">
                  <FontAwesomeIcon
                    icon={faCheck}
                    style={{ marginRight: "0.5vw", color: "#87CEEB" }}
                  />{" "}
                  Profile Name set to:
                </h3>
                <h3 className="h3-profileName-textValue">
                  {profileNameValue || "Anonymous User"}
                </h3>
              </>
            ) : (
              <></>
        ...
        <hr className="divider-mobile-screen"></hr>

        <div className="div-profilePage-text">
          {profileNameTooLong && (
            <RedWarningAlert
              textProps={
                "Oops! Your username should be kept under 30 characters"
              }
          ...
          <h3 className="h3-profilePage-text">
            <FontAwesomeIcon
              icon={faUserSecret}
              style={{ marginRight: "1vw", color: "#87CEEB" }}
            />
            Customize your identity to reflect your preference. Whether you
            choose to use your name or to be anonymous.
            <br />
          ...
          <h3 className="h3-profilePage-text-last">
            <FontAwesomeIcon
              ...
              style={{ marginRight: "1vw", color: "#87CEEB" }}
            />
            Respectful usernames and posts aligned with the app's purpose
            enhance the positive atmosphere of our community.
          </h3>
        </div>
      </div>
    </>
